...
## [5.4.2](https://github.com/libp2p/js-libp2p/compare/interface-compliance-tests-v5.4.1...interface-compliance-tests-v5.4.2) (2024-04-23)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/peer-id-factory bumped from ^4.0.10 to ^4.0.11
